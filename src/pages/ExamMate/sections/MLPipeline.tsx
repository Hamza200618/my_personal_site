...
import { EXAMMATE_ML_PIPELINE } from '@/data/exammate';
...
/**
 * MLPipeline — visual machine learning workflow.
 */
export function MLPipeline() {
  return (
    <Section aria-label="Machine learning pipeline" className="relative overflow-hidden">
      ...
      <Container className="relative z-10">
        <SectionTitle title={EXAMMATE_ML_PIPELINE.title} subtitle={EXAMMATE_ML_PIPELINE.subtitle} align="center" />
        <motion.ol
        ...
        >
          {EXAMMATE_ML_PIPELINE.steps.map((step, index) => (
            <motion.li key={step.title} variants={itemVariants}>
              ...
              {index < EXAMMATE_ML_PIPELINE.steps.length - 1 && (
